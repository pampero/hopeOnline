<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl" %>
    <% 
        ...
        settings =>
        {
            ...
            settings.CallbackRouteValues = new { Controller = "BackOffice", Action = "OrphanOrderGridView" };
            ...
            {%>
                ...
                <%= Html.ActionLink("Eliminar", "OrderDelete", new { id = DataBinder.Eval(c.DataItem, "OrderID") }).ToHtmlString().Replace("Eliminar", "<img title='Eliminar' src=\'/Content/imgs/backoffice/delete.gif\' style='border:0px' />")%> 
            <%});
