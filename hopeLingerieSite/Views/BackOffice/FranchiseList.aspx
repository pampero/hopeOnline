...
//<![CDATA[
       function SelectionChanged(s, e) {
           ...
           s.GetSelectedFieldValues("FranchiseId", GetSelectedFieldValuesCallback);
       }
...
// ]]>
    ...
    <% 
        using (Html.BeginForm("ExportFranchisesToXls", "Print"))
        {%>
  ...
  <td><%
    ...
    <%  Html.DevExpress().Button(
            settings =>
            {
                ...
                settings.ClientSideEvents.Click = "function(s, e) { gvFranchises.SelectRows(); }";
                settings.UseSubmitBehavior = false;
            })
            .Render(); %>
            ...
            settings =>
            {
                ...
                settings.ClientSideEvents.Click = "function(s, e) { gvFranchises.UnselectRows(); }";
                settings.UseSubmitBehavior = false;
            })
            .Render(); %>
            </td>
   ...
   <%     }
    %>
<%
    Html.RenderPartial("FranchiseGridView", Model); 
%>
