...
<script type="text/javascript">
    ...
    function fnEditar() {
        ...
        if (gvProducto.GetSelectedRowCount() == 1) {
            window.location = "/BackOffice/SizeUpdate/" + Id;
        }
        else
    ...
    function fnEliminar() {
        ...
        if (gvProducto.GetSelectedRowCount() == 1)
            if (confirm("Está seguro de eliminar el talle?"))
                window.location = "/BackOffice/SizeDelete/" + Id;
            else
                alert("Seleccione un Cupón");
    }

    function fCrear() {
        window.location = "/BackOffice/SizeUpdate/-1";
    }

    function grid_SelectionChanged(s, e) {

        s.GetSelectedFieldValues("SizeID", GetSelectedFieldValuesCallback);
    }
   ...
   <h2>
    ...
    <br />
<%
    Html.RenderPartial("SizeGridView", Model); 
%>
