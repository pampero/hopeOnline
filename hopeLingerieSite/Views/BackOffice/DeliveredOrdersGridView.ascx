<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl" %>
    <% 
        ...
        settings =>
        {
            ...
            settings.CallbackRouteValues = new { Controller = "BackOffice", Action = "DeliveredOrdersGridView" };
            ...
            {%>
                <%= Html.ActionLink("Ver", "DeliveredOrder", new { id = DataBinder.Eval(c.DataItem, "OrderID") }).ToHtmlString().Replace("Ver", "<img title='Ver' src=\'/Content/imgs/backoffice/edit.png\' style='border:0px' />")%> 
            <%});
