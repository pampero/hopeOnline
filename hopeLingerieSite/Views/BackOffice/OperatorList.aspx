...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function fCrear() {
            window.location = "/BackOffice/OperatorUpdate/-1";
        }
    ...
    <br />
    <% 
        using (Html.BeginForm("ExportOperatorsToXls", "Print"))
        {
    ...
    .Render();    %>
            ...
            settings =>
            {
                ...
                settings.ClientSideEvents.Click = "function(s, e) { gvOperators.SelectRows(); }";
                settings.UseSubmitBehavior = false;
            })
            .Render(); %>
            </td>
            ...
            settings =>
            {
                ...
                settings.ClientSideEvents.Click = "function(s, e) { gvOperators.UnselectRows(); }";
                settings.UseSubmitBehavior = false;
            })
            .Render(); %>
            </td>
    ...
    %>
    <%
        Html.RenderPartial("OperatorGridView", Model); 
    %>
</asp:Content>
